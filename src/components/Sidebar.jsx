...
const Sidebar = () => {
  ...
  const toggleSidebar = () => {
    ...
    setToggle((prev) => {
      const newState = !prev;
      if (newState) {
        sidebar.style.transform = "translateX(-215px)";
      } else {
    ...
    <div className="container-fluid sidebar" id="sidebarAll">
      ...
      >
        <div>
          ...
          >
            <span className="ms-1 fs-4" id="brand">
              {t("sidebar.title")}
            </span>
          </Link>
          ...
          <ul className="nav nav-pills flex-column">
            ...
            <li className="nav-item fs-4">
              <Link to="/calendar" className="nav-link fs-5">
                <i className="bi bi-calendar"></i>
                <span className="ms-3">{t("sidebar.calendar")}</span>
              </Link>
            </li>
            <li className="nav-item fs-4">
          ...
          <div className="dropdown open">
            ...
            >
              ...
              {!profileImage && (
                <img src={userPhoto} alt="Profile" className="sidebar-photo" />
              )}
              <span className="ms-3">{username}</span>
            </a>
            <div
              className="dropdown-menu fixed-top align-content-center"
