    ...
    <div>
      <form onSubmit={handleSubmit} className='todo-form'>
        ...
        <select name="priority" id="priority" className='prioSelect'>
          ...
          <option value={t('myTasks.select2')}>{t('myTasks.select2')}</option>
          <option value={t('myTasks.select3')}>{t('myTasks.select3')}</option>
        </select>
        <button type='submit' className='btn btn-secondary' style={{ height: "40px", color:"#fff" }}>{t('myTasks.addTask')}</button>
